...
hitCounter.hit(6)
hitCounter.hit(7)
print(hitCounter.getHits(7))
print(hitCounter.getHits(10))
print(hitCounter.getHits(12))
print(hitCounter.getHits(13))

let hitCounter2 = HitCounter()
hitCounter2.hit(1)
hitCounter2.hit(2)
hitCounter2.hit(7)
hitCounter2.hit(15)
print(hitCounter2.getHits(15))
print(hitCounter2.getHits(20))
print(hitCounter2.getHits(25))
hitCounter2.hit(15)
hitCounter2.hit(15)
hitCounter2.hit(16)
hitCounter2.hit(17)
...
hitCounter2.hit(18)
hitCounter2.hit(18)
print(hitCounter2.getHits(19))
hitCounter2.hit(31)
print(hitCounter2.getHits(36))

let hitCounter3 = HitCounter()
hitCounter3.hit(1)
hitCounter3.hit(2)
hitCounter3.hit(3)
print(hitCounter3.getHits(4))
hitCounter3.hit(300)
print(hitCounter3.getHits(4))

print("PhoneDirectory")

let phoneDirectory = PhoneDirectory(5)
print(phoneDirectory.check(0))
print(phoneDirectory.check(1))
print(phoneDirectory.check(2))
print(phoneDirectory.check(3))
print(phoneDirectory.check(4))
print(phoneDirectory.check(5))
...
let queue = QueueUsingArrayStacks()
queue.push(1)
queue.push(2)
queue.push(3)
queue.push(4)
